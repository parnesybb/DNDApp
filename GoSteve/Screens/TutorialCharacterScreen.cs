...
namespace GoSteve.Screens
{
    ...
    public class TutorialCharacterScreen : Activity
    {
        ...
        public TutorialCharacterScreen()
        {
        }
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            alert.SetMessage("On this screen you will be able to view all of the choices you have made and this will serve as your character sheet.  After 1 minute, the character sheet will be saved on your phone and you will be able to load it at a future time and send this information to your Dungeon Master (DM).");
            alert.SetCancelable(false);
            alert.SetPositiveButton("OK", delegate
            {
                alert.SetMessage("Thank you for viewing the character creation tutorial.");
                alert.SetPositiveButton("OK", delegate
                {
