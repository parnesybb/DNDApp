...
namespace GoSteve
{
    ...
    public class Tutorial2Screen : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            Button[] btns = { barbarianBtn, bardBtn, clericBtn, druidBtn, fighterBtn, monkBtn, paladinBtn, rangerBtn, rogueBtn, sorcerorBtn, warlockBtn, wizardBtn };
            ...
            barbarianBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.BARBARIAN;
            ...
            bardBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.BARD;
            ...
            clericBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.CLERIC;
            ...
            druidBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.DRUID;
            ...
            fighterBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.FIGHTER;
            ...
            monkBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.MONK;
            ...
            paladinBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.PALADIN;
            ...
            rangerBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.RANGER;
            ...
            rogueBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.ROGUE;
            ...
            sorcerorBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.SORCERER;
            ...
            warlockBtn.Click += (s, arg) =>
            {
                ...
                classDesc.Text = desc;
                theClass = KnownValues.ClassType.WARLOCK;
            ...
            alert.SetMessage("In this step of the character creation process, we pick a class for our Hero.  Class type determines what kind of abilities our Hero will have.  Keeping with our theme, Harry Potter is a wizard, so we will select the wizard button.  Note that the text field below the button fills with important information about the class we have chosen.  Be sure to read these decriptions before making a selection.  Press the continue button to proceed.");
